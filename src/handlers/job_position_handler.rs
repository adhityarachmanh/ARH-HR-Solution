...
use crate::models::{JobPosition, PaginationParams};
...
pub async fn list_job_positions(
    ...
    tera: web::Data<Tera>,
    session: Session,
    params: web::Query<PaginationParams>, // Tambahkan parameter pagination
    ...
    context.insert("positions", &positions); // Pastikan nama variabel "positions"
